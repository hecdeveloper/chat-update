...
const Window = () => {
  return (
    <>
      <div className="row-span-4 px-4 mt-4 bg-slate-900 lg:col-span-4 lg:row-span-4 md:col-span-5 md:pr-10">
        {/* search and stuff */}
        ...
        <div className="grid cols-1 md:grid-cols-6 min-h-[85%] rounded-b-lg bg-slate-100">
          <div className="rounded-bl-lg bg-slate-100 md:mr-3 md:col-span-2">
            <Tabs />
          </div>
